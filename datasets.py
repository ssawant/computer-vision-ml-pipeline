...
from utils.transforms import (
    get_train_transform, get_valid_transform, get_train_aug
)


class CustomDataset(Dataset):
    def __init__(self, images_path, labels_path, width, height, classes, transforms=None, use_train_aug=False, train=False, mosaic=False) -> None:
        super().__init__()
    ...
    def load_image_and_labels(self, index):
        ...
        image_resized /= 255.0  # normalize image

        # Capture the correspinding XML file for getting the annotation.
